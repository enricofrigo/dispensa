            ...
            barcodeScanner.process(image)
                ...
                textRecognizer.process(image)
                        .addOnSuccessListener(text -> {
                            ...
                            String parsedDate = eu.frigo.dispensa.util.ExpiryDateParser.parseExpiryDate(resultText);
                            if (parsedDate != null) {
                            runOnUiThread(() -> {
        ...
        addProductViewModel.getAllSelectableLocations().observe(this, locations -> {
            if (locations != null && !locations.isEmpty()) {
                ...
                for (StorageLocation loc : locations) {
                    locationDisplayNames.add(eu.frigo.dispensa.util.LocationFormatter.getLocalizedName(getApplicationContext(), loc));
                }
                    ...
                    textTask = textRecognizer.process(image)
                            .addOnSuccessListener(text -> {
                                ...
                                String parsedDate = isRescanning
                                        ? eu.frigo.dispensa.util.ExpiryDateParser.parseExpiryDateFullOnly(resultText)
                                        : eu.frigo.dispensa.util.ExpiryDateParser.parseExpiryDate(resultText);
